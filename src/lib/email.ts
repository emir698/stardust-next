export async function sendBiletMail(
  ...
  const biletHtml = '<table style="width:100%;border-collapse:collapse;font-family:sans-serif;font-size:14px;">'
    ...
    + '<tr style="background:#f9f9f9"><td style="padding:8px;color:#888;">Toplam</td><td style="padding:8px;font-weight:bold;color:#2e7d32;">' + toplamStr + '</td></tr>'
    + '</table>';
