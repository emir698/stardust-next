...
export function Tabs() {
  ...
  return (
    <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '2rem' }}>
      <div style={{ display: 'flex', gap: 2, background: 'var(--color-sf)', border: '1px solid var(--color-bd)', borderRadius: 10, padding: 4, width: 'fit-content', flexWrap: 'wrap', justifyContent: 'center' }}>
        {visible.map((tab) => {
